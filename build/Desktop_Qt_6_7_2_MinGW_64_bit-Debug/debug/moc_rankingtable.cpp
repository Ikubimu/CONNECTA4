...
struct qt_meta_stringdata_CLASSrankingTableENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSrankingTableENDCLASS = QtMocHelpers::stringData(
    "rankingTable"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSrankingTableENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject rankingTable::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSrankingTableENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSrankingTableENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSrankingTableENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *rankingTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSrankingTableENDCLASS.stringdata0))
